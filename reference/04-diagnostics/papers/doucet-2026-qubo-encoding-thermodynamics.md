...
> **Citation.** Canonical entry `doucet2026` in [`references.bib`](../../references.bib) (resolved via Crossref/DataCite). DOI [10.1088/1367-2630/ae6e98](https://doi.org/10.1088/1367-2630/ae6e98) · arXiv:[2601.04402](https://arxiv.org/abs/2601.04402).
>
> **Companion note.** [`doucet-2026-qubo-encoding-thermodynamics.note.md`](./doucet-2026-qubo-encoding-thermodynamics.note.md) — how this paper links to Gibbsiq.
