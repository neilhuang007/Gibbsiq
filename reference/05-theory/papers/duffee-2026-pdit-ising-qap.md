...
> **Citation.** Canonical entry `duffee2026qap` in [`references.bib`](../../references.bib) (resolved via Crossref/DataCite). arXiv:[2605.24408](https://arxiv.org/abs/2605.24408).
>
> **Companion note.** [`duffee-2026-pdit-ising-qap.note.md`](./duffee-2026-pdit-ising-qap.note.md) — how this paper links to Gibbsiq.
