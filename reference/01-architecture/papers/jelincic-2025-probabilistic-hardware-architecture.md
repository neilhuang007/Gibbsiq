...
> **Citation.** Canonical entry `jelincic2025` in [`references.bib`](../../references.bib) (resolved via Crossref/DataCite). arXiv:[2510.23972](https://arxiv.org/abs/2510.23972).
>
> **Companion note.** [`jelincic-2025-probabilistic-hardware-architecture.note.md`](./jelincic-2025-probabilistic-hardware-architecture.note.md) — how this paper links to Gibbsiq.
