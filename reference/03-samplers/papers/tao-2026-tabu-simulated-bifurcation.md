...
> **Citation.** Canonical entry `tao2026` in [`references.bib`](../../references.bib) (resolved via Crossref/DataCite). DOI [10.1038/s42005-026-02538-2](https://doi.org/10.1038/s42005-026-02538-2).
>
> **Companion note.** [`tao-2026-tabu-simulated-bifurcation.note.md`](./tao-2026-tabu-simulated-bifurcation.note.md) — how this paper links to Gibbsiq.
