...
3. [Agentic evaluation research](agentic-evaluation-research.md) - what should be public tests, what should be blind tests, and how to prevent fixture-echo cheating.
4. [Fixtures](fixtures/README.md) - machine-readable exact inputs and expected outputs.
5. [Implementation source candidates](source-implementation-candidates.md) - primary source repos that can be modeled or copied from when licenses permit.
